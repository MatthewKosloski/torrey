...
run_binary_relational_less_than_or_equal_to_expr_tests () {
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (1:8)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (1:22)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (1:20)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:6)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:8)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:25)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (1:18)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:22)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (1:24)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:33)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:16)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (1:18)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (2:14)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'NIL' instead (2:14)
...
Expected operand to operator '<=' to be type 'INTEGER' but found type 'BOOLEAN' instead (1:15)
...
2 Errors"
  ...
  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are negative integers and the first is less than the second" \
    $1 \
    "(if (<= (- 2) (- 1)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are negative integers and the first is equal to the second" \
    $1 \
    "(if (<= (- 1) (- 1)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands are negative integers and the second is less than the first" \
    $1 \
    "(if (<= (- 1) (- 2)) (print 1) (print 0))" \
    "0"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are positive integers and the first is less than the second" \
    $1 \
    "(if (<= 1 2) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are positive integers and the first is equal to the second" \
    $1 \
    "(if (<= 1 1) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands are positive integers and the second is less than the first" \
    $1 \
    "(if (<= 2 1) (print 1) (print 0))" \
    "0"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are addition expressions and the first is less than the second" \
    $1 \
    "(if (<= (+ 0 1) (+ 2 3)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are addition expressions and the first is equal to the second" \
    $1 \
    "(if (<= (+ 2 3) (+ 2 3)) (print 1) (print 0))" \
    "1"


  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands are addition expressions and the second is less than the first" \
    $1 \
    "(if (<= (+ 0 1) (+ (- 999) 3)) (print 1) (print 0))" \
    "0"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are subtraction expressions and the first is less than the second" \
    $1 \
    "(if (<= (- 1 999) (- 2 3)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are subtraction expressions and the first is equal to the second" \
    $1 \
    "(if (<= (- 1 999) (- 1 999)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands are subtraction expressions and the second is less than the first" \
    $1 \
    "(if (<= (- 2 3) (- 1 999)) (print 1) (print 0))" \
    "0"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are multiplication expressions and the first is less than the second" \
    $1 \
    "(if (<= (* 0 1) (* 2 3)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are multiplication expressions and the first is equal to the second" \
    $1 \
    "(if (<= (* 2 3) (* 2 3)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands are multiplication expressions and the second is less than the first" \
    $1 \
    "(if (<= (* 2 3) (* 0 1)) (print 1) (print 0))" \
    "0"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are division expressions and the first is less than the second" \
    $1 \
    "(if (<= (/ 0 1) (/ 16 4)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands are division expressions and the first is equal to the second" \
    $1 \
    "(if (<= (/ 0 1) (/ 0 1)) (print 1) (print 0))" \
    "1"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands are division expressions and the second is less than the first" \
    $1 \
    "(if (<= (/ 16 4) (/ 0 1)) (print 1) (print 0))" \
    "0"

  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands evaluate to identifiers and the first is less than the second" \
    $1 \
    "(let [a 1 b 2]
  ...
  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to true if both operands evaluate to identifiers and the first is equal to the second" \
    $1 \
    "(let [a 1 b a]
       (if (<= a b) (print 1) (print 0)))" \
    "1"
  ...
  assert_exec_stdout_equalto_with_stdin \
    "Should evaluate to false if both operands evaluate to identifiers and the second is less than the first" \
    $1 \
    "(let [a 2 b 1]
       (if (<= a b) (print 1) (print 0)))" \
    "0"
